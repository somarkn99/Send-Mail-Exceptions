    ...
    <div class="exception-summary">
        <div class="container">
            <div class="exception-message-wrapper">
                <h1 class="break-long-words exception-message">{{ $exceptionData['message'] ?? '' }}</h1>
                ...
                <thead class="trace-head">
                    <tr>
                        <th>
                            ...
                            <p class="break-long-words trace-message">{{ $exceptionData['message'] ?? '' }}</p>
                            <p class="">URL: {{ $exceptionData['url'] ?? '' }}</p>
                            <p class="">IP: {{ $exceptionData['ip'] ?? '' }}</p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <span class="block trace-file-path">in <span
                                    title="{{ $exceptionData['file'] ?? '' }}"><strong>{{ $exceptionData['file'] ?? '' }}</strong>
                                    line {{ $exceptionData['line'] ?? '' }}</span></span>
                        </td>
                    </tr>
                    @foreach ($exceptionData['trace'] ?? [] as $value)
                        <tr>
                            <td>
